...
# In this example, we've asked Slurm for 8 tasks, but we've asked mpirun for 4 and 8 MPI procs, which will go onto 2 and 4 nodes.
echo ""
echo "p = 4"
